...
const styles = StyleSheet.create({
  ...
  closeBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.card, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.glassBorder },
  ...
  friendChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: colors.card, borderRadius: radius.pill, paddingVertical: 6, paddingHorizontal: 10, borderWidth: 1, borderColor: colors.glassBorder },
  ...
  reactPill: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: colors.card, borderRadius: radius.pill, paddingVertical: 9, paddingHorizontal: 13, borderWidth: 1, borderColor: colors.glassBorder },
